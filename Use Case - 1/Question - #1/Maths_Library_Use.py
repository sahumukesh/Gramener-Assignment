...
print 'Average Percentage of Maths Marks of Library use 1 (No computer)- ',((marks_1/count_1))
print 'Average Percentage of Maths Marks of Library use 2 (Never use)- ',((marks_2/count_2))
print 'Average Percentage of Maths Marks of Library use 3 (Once or twice in a month)- ',((marks_3/count_3))
print 'Average Percentage of Maths Marks of Library use 4 (Once in a week)- ',((marks_4/count_4))
print 'Average Percentage of Maths Marks of Library use 5 (More than once in a week)- ',((marks_5/count_5))

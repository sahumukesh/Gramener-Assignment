...
print 'Average Percentage of Maths Marks of Use dictionary 1 (No)- ',((marks_1/count_1))
print 'Average Percentage of Maths Marks of Use dictionary 2 (Yes)- ',((marks_2/count_2))

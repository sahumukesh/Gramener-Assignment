...
print 'Average Percentage of Maths Marks of Private tuition 1 (No)- ',((marks_2/count_2))
print 'Average Percentage of Maths Marks of Private tuition 2 (Yes)- ',((marks_3/count_3))
